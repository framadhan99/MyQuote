...
import com.fajar.myquote.databinding.ActivityListQuotesBinding
...
class ListQuotesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.listQuotes.setLayoutManager(layoutManger)
        val itemDecoration = DividerItemDecoration(this, layoutManger.orientation)
